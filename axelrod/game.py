...
from axelrod import Action, BaseGame
...
class Game():  # pragma: no cover
    def __init__(self):
        raise DeprecationWarning("Please change path from axelrod.game.Game to axelrod.Game")


class IpdGame(BaseGame):
    ...
    def __eq__(self, other):
        if not isinstance(other, IpdGame):
            return False
