...
from axelrod.ipd.interaction_utils import (
    compute_final_score_per_turn,
    read_interactions_from_file,
)
from axelrod.ipd.strategy_transformers import DualTransformer, JossAnnTransformer
...
def _create_jossann(point: Point, probe: Any) -> IpdPlayer:
    ...
    probe : class or instance
        A class that must be descended from axelrodPlayer or an instance of
        axelrodPlayer.
...
class AshlockFingerprint(object):
    ...
    def _construct_tournament_elements(
        ...
        tournament_players : list
            A list containing instances of axelrodPlayer. The first item is the
