...
from axelrod.ipd.strategy_transformers import InitialTransformer

C, D = Action.C, Action.D


@InitialTransformer((D, D, D, D, D, C, C), name_prefix=None)
class GradualKiller(IpdPlayer):
    """
    ...
    Initially designed to stop Gradual from defeating TitForTat in a 3 IpdPlayer
    tournament.
