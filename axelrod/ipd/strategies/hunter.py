...
from axelrod.ipd._strategy_utils import detect_cycle
...
class DefectorHunter(IpdPlayer):
...
class CooperatorHunter(IpdPlayer):
...
class AlternatorHunter(IpdPlayer):
...
class EventualCycleHunter(CycleHunter):
    ...
    def strategy(self, opponent: IpdPlayer) -> None:
...
class MathConstantHunter(IpdPlayer):
