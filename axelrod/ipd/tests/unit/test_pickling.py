...
PointerToWrappedClassNotInStrategies = axl.ipd.strategy_transformers.FlipTransformer()(
    axl.ipd.strategy_transformers.FlipTransformer()(MyDefector)
)


@axl.ipd.strategy_transformers.InitialTransformer((D, C, D), name_prefix=None)
@axl.ipd.strategy_transformers.DualTransformer(name_prefix=None)
@axl.ipd.strategy_transformers.FlipTransformer(name_prefix=None)
@axl.ipd.strategy_transformers.DualTransformer(name_prefix=None)
class InterspersedDualTransformersNamePrefixAbsent(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.IdentityTransformer((D, D, C))
@axl.ipd.strategy_transformers.DualTransformer()
...
@axl.ipd.strategy_transformers.ApologyTransformer([D], [C], name_prefix=None)
class Apology(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.DeadlockBreakingTransformer(name_prefix=None)
...
@axl.ipd.strategy_transformers.FinalTransformer((D, D), name_prefix=None)
class Final(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.ForgiverTransformer(0.2, name_prefix=None)
class Forgiver(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.GrudgeTransformer(3, name_prefix=None)
class Grudge(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.InitialTransformer((C, D), name_prefix=None)
class Initial(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.JossAnnTransformer((0.2, 0.2), name_prefix=None)
...
@axl.ipd.strategy_transformers.MixedTransformer(probability, strategies, name_prefix=None)
class Mixed(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.NiceTransformer(name_prefix=None)
class Nice(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.NoisyTransformer(0.2, name_prefix=None)
class Noisy(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.RetaliationTransformer(3, name_prefix=None)
class Retaliation(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.RetaliateUntilApologyTransformer(name_prefix=None)
class RetaliateUntilApology(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.TrackHistoryTransformer(name_prefix=None)
class TrackHistory(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.IdentityTransformer()
class Identity(axl.Cooperator):
    pass


@axl.ipd.strategy_transformers.IdentityTransformer(name_prefix=None)
...
TransformedMetaThue = axl.ipd.strategy_transformers.IdentityTransformer(name_prefix=None)(MetaThue)
...
transformer_instances = [
    axl.ipd.strategy_transformers.ApologyTransformer([D], [C]),
    axl.ipd.strategy_transformers.DeadlockBreakingTransformer(),
    axl.ipd.strategy_transformers.DualTransformer(),
    axl.ipd.strategy_transformers.FlipTransformer(),
    axl.ipd.strategy_transformers.FinalTransformer((D, D)),
    axl.ipd.strategy_transformers.ForgiverTransformer(0.2),
    axl.ipd.strategy_transformers.GrudgeTransformer(3),
    axl.ipd.strategy_transformers.InitialTransformer((C, D)),
    axl.ipd.strategy_transformers.JossAnnTransformer((0.2, 0.6)),
    axl.ipd.strategy_transformers.MixedTransformer(probability, strategies),
    axl.ipd.strategy_transformers.NiceTransformer(),
    axl.ipd.strategy_transformers.NoisyTransformer(0.2),
    axl.ipd.strategy_transformers.RetaliationTransformer(3),
    axl.ipd.strategy_transformers.RetaliateUntilApologyTransformer(),
    axl.ipd.strategy_transformers.TrackHistoryTransformer(),
    axl.ipd.strategy_transformers.IdentityTransformer(),
]
...
class TestPickle(unittest.TestCase):
    ...
    def test_sequence_player(self):
        inline_transformed_thue = axl.ipd.strategy_transformers.IdentityTransformer(name_prefix="Transformed")(axl.ThueMorse)()
    ...
    def test_created_on_the_spot_multiple_transformers(self):
        player_class = axl.ipd.strategy_transformers.FlipTransformer()(axl.Cooperator)
        player_class = axl.ipd.strategy_transformers.DualTransformer()(player_class)
        player = axl.ipd.strategy_transformers.FinalTransformer((C, D))(player_class)()
    ...
    def test_dual_transformer_regression_test(self):
        ...
        player_class = axl.ipd.strategy_transformers.DualTransformer()(player_class)
        player_class = axl.ipd.strategy_transformers.InitialTransformer((C, D))(player_class)
        player_class = axl.ipd.strategy_transformers.DualTransformer()(player_class)
        player_class = axl.ipd.strategy_transformers.TrackHistoryTransformer()(player_class)
    ...
    def test_local_class_unpicklable(self):
        ...
        player = axl.ipd.strategy_transformers.FlipTransformer()(LocalCooperator)()
    ...
    def test_with_various_name_prefixes(self):
        ...
        default_prefix = axl.ipd.strategy_transformers.FlipTransformer()(axl.Cooperator)()
        self.assertEqual(default_prefix.__class__.__name__, "FlippedCooperator")
        self.assert_original_equals_pickled(default_prefix)

        fliptastic = axl.ipd.strategy_transformers.FlipTransformer(name_prefix="Fliptastic")
    ...
    def test_dynamic_class_no_name_prefix(self):
        player = axl.ipd.strategy_transformers.FlipTransformer(name_prefix=None)(axl.Cooperator)()
