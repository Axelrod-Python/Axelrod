...
from axelrod.ipd.load_data_ import axl_filename
...
class TestPlot(unittest.TestCase):
    ...
    def test_default_cmap(self):
        cmap = axl.ipd.plot.default_cmap("0.0")
        self.assertEqual(cmap, "YlGnBu")

        cmap = axl.ipd.plot.default_cmap("1.3alpha")
        self.assertEqual(cmap, "YlGnBu")

        cmap = axl.ipd.plot.default_cmap("1.4.99")
        self.assertEqual(cmap, "YlGnBu")

        cmap = axl.ipd.plot.default_cmap("1.4")
        self.assertEqual(cmap, "YlGnBu")

        cmap = axl.ipd.plot.default_cmap()
        self.assertEqual(cmap, "viridis")

        cmap = axl.ipd.plot.default_cmap("1.5")
        self.assertEqual(cmap, "viridis")

        cmap = axl.ipd.plot.default_cmap("1.5beta")
        self.assertEqual(cmap, "viridis")

        cmap = axl.ipd.plot.default_cmap("1.7")
        self.assertEqual(cmap, "viridis")

        cmap = axl.ipd.plot.default_cmap("2.0")
        self.assertEqual(cmap, "viridis")
