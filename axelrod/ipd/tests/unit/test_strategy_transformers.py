...
from axelrod.ipd.strategy_transformers import *
from axelrod.ipd.tests.strategies.test_cooperator import TestCooperator
from axelrod.ipd.tests.strategies.test_titfortat import TestTitForTat
