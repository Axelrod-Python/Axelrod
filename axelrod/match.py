...
from axelrod.game import IpdGame
...
class Match():  # pragma: no cover
    def __init__(self):
        raise DeprecationWarning("Please change path from axelrod.match.Match to axelrod.Match")
...
class IpdMatch(BaseMatch):
    """The IpdMatch class conducts matches between two players."""
    ...
    def __init__(
        ...
        super().__init__(
            players, turns, prob_end, game, noise, match_attributes, reset
        )
    ...
    def scores(self):
        """Returns the scores of the previous IpdMatch plays."""
        return iu.compute_scores(self.result, self.game)

    def final_score(self):
        """Returns the final score for a IpdMatch."""
        return iu.compute_final_score(self.result, self.game)

    def final_score_per_turn(self):
        """Returns the mean score per round for a IpdMatch."""
