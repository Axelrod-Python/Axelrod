"""
Test for the inverse proportional grudger strategy
"""
import unittest
import axelrod
import random

class TestInverseProportionalGrudger(unittest.TestCase):

    def test_init(self):
        """
        Tests for the __init__ method
        """
        P1 = axelrod.InverseProportionalGrudger()
    ...
    def test_representation(self):
        P1 = axelrod.InverseProportionalGrudger()
        self.assertEqual(str(P1), 'Inverse Proportional Grudger')
