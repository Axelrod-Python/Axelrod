"""
Test for the proportinal grudger strategy
"""
import unittest
import axelrod
import random

class TestProportionalGrudger(unittest.TestCase):

    def test_init(self):
        """
        Tests for the __init__ method
        """
        P1 = axelrod.ProportionalGrudger()
    ...
    def test_representation(self):
        P1 = axelrod.ProportionalGrudger()
        self.assertEqual(str(P1), 'Proportional Grudger')
