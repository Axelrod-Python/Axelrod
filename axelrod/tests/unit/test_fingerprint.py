...
class TestFingerprint(unittest.TestCase):
    ...
    def test_wsls_fingerprint(self):
        ...
        test_data = {Point(x=0.0, y=0.0): 3.0,
                     Point(x=0.0, y=0.25): 1.72,
                     Point(x=0.0, y=0.5): 1.62,
                     Point(x=0.0, y=0.75): 0.90,
                     Point(x=0.0, y=1.0): 0.5,
                     Point(x=0.25, y=0.0): 3.0,
                     Point(x=0.25, y=0.25): 2.32,
                     Point(x=0.25, y=0.5): 1.68,
                     Point(x=0.25, y=0.75): 1.5,
                     Point(x=0.25, y=1.0): 0.85,
                     Point(x=0.5, y=0.0): 3.0,
                     Point(x=0.5, y=0.25): 2.85,
                     Point(x=0.5, y=0.5): 2.48,
                     Point(x=0.5, y=0.75): 1.43,
                     Point(x=0.5, y=1.0): 1.05,
                     Point(x=0.75, y=0.0): 3.0,
                     Point(x=0.75, y=0.25): 2.98,
                     Point(x=0.75, y=0.5): 3.20,
                     Point(x=0.75, y=0.75): 2.54,
                     Point(x=0.75, y=1.0): 1.19,
                     Point(x=1.0, y=0.0): 3.0,
                     Point(x=1.0, y=0.25): 4.64,
                     Point(x=1.0, y=0.5): 4.86,
                     Point(x=1.0, y=0.75): 4.19,
    ...
    def test_tft_fingerprint(self):
        axl.seed(0)  # Fingerprinting is a random process
        test_data = {Point(x=0.0, y=0.0): 3.0,
                     Point(x=0.0, y=0.25): 1.88,
                     Point(x=0.0, y=0.5): 1.07,
                     Point(x=0.0, y=0.75): 1.02,
                     Point(x=0.0, y=1.0): 0.98,
                     Point(x=0.25, y=0.0): 3.0,
                     Point(x=0.25, y=0.25): 2.27,
                     Point(x=0.25, y=0.5): 1.72,
                     Point(x=0.25, y=0.75): 1.80,
                     Point(x=0.25, y=1.0): 1.53,
                     Point(x=0.5, y=0.0): 3.0,
                     Point(x=0.5, y=0.25): 2.65,
                     Point(x=0.5, y=0.5): 2.31,
                     Point(x=0.5, y=0.75): 1.99,
                     Point(x=0.5, y=1.0): 1.86,
                     Point(x=0.75, y=0.0): 3.0,
                     Point(x=0.75, y=0.25): 2.73,
                     Point(x=0.75, y=0.5): 2.47,
                     Point(x=0.75, y=0.75): 2.29,
                     Point(x=0.75, y=1.0): 2.16,
                     Point(x=1.0, y=0.0): 3.0,
                     Point(x=1.0, y=0.25): 2.79,
                     Point(x=1.0, y=0.5): 2.59,
                     Point(x=1.0, y=0.75): 2.36,
    ...
    def test_majority_fingerprint(self):
        axl.seed(0)  # Fingerprinting is a random process
        test_data = {Point(x=0.0, y=0.0): 3.0,
                     Point(x=0.0, y=0.25): 1.96,
                     Point(x=0.0, y=0.5): 1.0700000000000001,
                     Point(x=0.0, y=0.75): 1.0,
                     Point(x=0.0, y=1.0): 0.97999999999999998,
                     Point(x=0.25, y=0.0): 3.0,
                     Point(x=0.25, y=0.25): 2.23,
                     Point(x=0.25, y=0.5): 1.6499999999999999,
                     Point(x=0.25, y=0.75): 2.1799999999999997,
                     Point(x=0.25, y=1.0): 1.97,
                     Point(x=0.5, y=0.0): 3.0,
                     Point(x=0.5, y=0.25): 2.3700000000000001,
                     Point(x=0.5, y=0.5): 2.27,
                     Point(x=0.5, y=0.75): 2.79,
                     Point(x=0.5, y=1.0): 2.5099999999999998,
                     Point(x=0.75, y=0.0): 3.0,
                     Point(x=0.75, y=0.25): 2.3100000000000001,
                     Point(x=0.75, y=0.5): 2.0999999999999996,
                     Point(x=0.75, y=0.75): 2.1100000000000003,
                     Point(x=0.75, y=1.0): 2.5300000000000002,
                     Point(x=1.0, y=0.0): 3.0,
                     Point(x=1.0, y=0.25): 2.25,
                     Point(x=1.0, y=0.5): 1.78,
                     Point(x=1.0, y=0.75): 1.8999999999999999,
                     Point(x=1.0, y=1.0): 2.2599999999999998}
