...
class TestFingerprint(unittest.TestCase):
    ...
    def test_default_init(self):
        ...
        self.assertEqual(fingerprint.probe.__class__, self.probe)

    def test_init(self):
        fingerprint = AshlockFingerprint(self.strategy, self.probe, step=0.5)
        self.assertEqual(fingerprint.player.__class__, self.strategy)
        self.assertEqual(fingerprint.probe.__class__, self.probe)
    ...
    def test_fingerprint_with_filename(self):
        ...
        af = AshlockFingerprint(self.strategy, self.probe, step=0.5)
        af.fingerprint(turns=1, repetitions=1, progress_bar=False,
                       filename=filename)
    ...
    def test_plot(self):
        af = AshlockFingerprint(self.strategy, self.probe, step=0.25, progress_bar=False)
        af.fingerprint(turns=10, repetitions=2, progress_bar=False)
        p = af.plot()
    ...
    def test_wsls_fingerprint(self):
        ...
        af = axl.AshlockFingerprint(self.strategy, self.probe, step=0.25, progress_bar=False)
    ...
    def test_tft_fingerprint(self):
        ...
        af = axl.AshlockFingerprint(axl.TitForTat, self.probe, step=0.25, progress_bar=False)
        data = af.fingerprint(turns=50, repetitions=2)
    ...
    def test_majority_fingerprint(self):
        ...
        af = axl.AshlockFingerprint(axl.GoByMajority, self.probe, step=0.25, progress_bar=False)
        data = af.fingerprint(turns=50, repetitions=2)
