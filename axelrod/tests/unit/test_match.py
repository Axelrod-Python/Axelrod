...
class TestSampleLength(unittest.TestCase):
    def test_sample_length(self):
        for seed, prob_end, expected_length in [
            ...
            axl.seed(seed)
            self.assertEqual(axl.ipd.match.sample_length(prob_end), expected_length)

    def test_sample_with_0_prob(self):
        self.assertEqual(axl.ipd.match.sample_length(0), float("inf"))

    def test_sample_with_1_prob(self):
        self.assertEqual(axl.ipd.match.sample_length(1), 1)
