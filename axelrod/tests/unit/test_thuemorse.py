...
class TestThueMorse(TestPlayer):
    ...
    def test_effect_of_strategy(self):
        ...
        self.responses_test([C], [C], [C, C, D, C, D, D, C, C, D, D, C, D, C, C, D])
        self.responses_test([D], [D], [C, C, D, C, D, D, C, C, D, D, C, D, C, C, D])
        self.responses_test([C, C, C, D], [C, C, C, D], [C, D, D, C, C, D, D, C, D, C, C, D])
...
class TestThueMorseInverse(TestPlayer):
    ...
    def test_effect_of_strategy(self):
        ...
        self.responses_test([C], [C], [D, D, C, D, C, C, D, D, C, C, D, C, D, D, C])
        self.responses_test([D], [D], [D, D, C, D, C, C, D, D, C, C, D, C, D, D, C])
        self.responses_test([C, C, C, D], [C, C, C, D], [D, C, C, D, D, C, C, D, C, D, D, C])