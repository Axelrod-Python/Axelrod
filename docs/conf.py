...
MOCK_MODULES = ['numpy', 'numpy.linalg', 'numpy.random', 'matplotlib.pyplot', 'matplotlib', 'matplotlib.transforms', 'mpl_toolkits.axes_grid1', 'cloudpickle', 'pathos.multiprocess']
