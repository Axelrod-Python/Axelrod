...
.. csv-table:: Strategies in Axelrod's second tournament
   ...
   "K34R_", "James W Friedman", ":class:`axelrod.strategies.grudger.Grudger`"
   ...
   "K46R_", "Graham J Eatherley", ":class:`axelrod.strategies.axelrod_second.Eatherley`"
   ...
   "K57R_", "Rudy Nydegger", ":class:`axelrod.strategies.axelrod_first.Nydegger`"
   "K58R_", "Glen Rowsam", "Not Implemented"
   "K59R_", "Leslie Downing", ":class:`axelrod.strategies.axelrod_first.RevisedDowning`"
   "K60R_", "Jim Graaskamp and Ken Katzen", "Not Implemented. Currently being worked on."
   "K61R_", "Danny C Champion", ":class:`axelrod.strategies.axelrod_second.Champion`"
   ...
   "K69R_", "Johann Joss", ":class:`axelrod.strategies.axelrod_first.Joss`"
   ...
   "K77R_", "Scott Feld", ":class:`axelrod.strategies.axelrod_first.Feld`"
   ...
   "K86R_", "Bernard Grofman", ":class:`axelrod.strategies.axelrod_first.Grofman`"
