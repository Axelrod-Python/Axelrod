...
+--------------------------+-------------------------------------------+--------------------------+
| K46R_                    | Eatherley                                 | :code:`Eatherley`        |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| K76R_                    | Gladstein                                 | :code:`Tester`           |
+--------------------------+-------------------------------------------+--------------------------+
| K77R_                    | Feld                                      | :code:`Feld`             |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| KPAVLOVC_                | Pavlov                                    | :code:`WSLS`             |
+--------------------------+-------------------------------------------+--------------------------+
| KRANDOMC_                | Random                                    | :code:`Random`           |
+--------------------------+-------------------------------------------+--------------------------+
| KTF2TC_                  | Tit for Two Tats                          | :code:`TitFor2Tats`      |
+--------------------------+-------------------------------------------+--------------------------+
| KTITFORTATC_             | Tit for Tat                               | :code:`TitForTat`        |
+--------------------------+-------------------------------------------+--------------------------+
