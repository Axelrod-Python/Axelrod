...
+--------------------------+-------------------------------------------+--------------------------+
| K46R_                    | Eatherley                                 | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| K57R_                    | Nydegger                                  | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| K61R_                    | Champion                                  | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| K77R_                    | Feld                                      | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| K78R_                    | Mauk                                      | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| K79R_                    | Ambuehl Hickey                            | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| K80R_                    | Dawes Batell                              | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| K84R_                    | Tideman Chieruzzi                         | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| K85R_                    | Falk Langsted                             | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
...
+--------------------------+-------------------------------------------+--------------------------+
| KPAVLOVC_                | Pavlov                                    | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| KRANDOMC_                | Random                                    | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| KTF2TC_                  | Tit for Two Tats                          | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
| KTITFORTATC_             | Tit for Tat                               | Not Implemented          |
+--------------------------+-------------------------------------------+--------------------------+
